...
class Contacts(ParallelAnalysisBase):
    ...
    **Contact API** prescribes that this method must be a function with call
    ...
    def __init__(
        ...
        updating: tuple[bool, bool] = (False, False),
        method: str = "hard_cut",
        radius: float = 4.5,
        label: str = None,
        verbose: bool = False,
        ...
        **basekwargs,
        ...
        self._ag1 = self._get_atomgroup(u, select[0], updating=updating[0])
        self._ag2 = self._get_atomgroup(u, select[1], updating=updating[1])
        self._radius = radius
