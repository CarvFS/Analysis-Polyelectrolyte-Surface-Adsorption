...
#SBATCH --exclude=node[11-14],zeal
...
dir_sims_base="/nfs/zeal_nas/home_mount/fscarv/projects/md/data/polymer-surface-ads/data_archive/9-defect-crystal-adsorption/cleaned"
