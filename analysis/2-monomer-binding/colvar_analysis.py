...
SIMULATION_SDIR: str = "sjobid_0-calcite-104surface-5nm_surface-8nm_vertical-1chain-PAcr-8mer-0Crb-0Ca-8Na-0Cl-300K-1bar-NVT"  # noqa: E501
...
def load_data(
    ...
    output_dir = Path(output_subdir) / method_no_replica
